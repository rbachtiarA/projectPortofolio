...
export default function Navbar() {
    ...
    return (
        <div className="sticky top-5 flex flex-col text-[#F7E7DC] font-semibold w-[100px] my-auto">
            <div className="font-bold self-center mb-5 animate-spin">
                <img src={BrandLogo} alt="Brand Logo" />
            </div>
            
            <div className="bg-[#405D72] rounded-tr-2xl rounded-br-2xl md:rounded-full flex flex-col gap-2 p-2">
