...
export default function Mainpage() {
    ...
    return (
        <div className="w-full flex flex-row row gap-6 p-5 flex-wrap md:flex-nowrap md:flex-row-reverse">
            
            <div className="flex flex-col gap-6 my-auto m-3 md:min-w-[325px] md:max-w-[1000px]">
            ...
            <div className="md:beach-bg bg-contain flex my-auto md:rounded-full md:border-8 md:min-w-[250px] md:border-orange-500">
